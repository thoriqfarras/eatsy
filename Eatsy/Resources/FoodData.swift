...
struct FoodData {
    ...
    static let dinner: [MealObject] = [
        ...
        MealObject(id: 1, mealType: .breakfast, menuName: "Omelet Sayur", calories: 500, protein: 10, carbs: 30, fat: 8, restrictions: [.lactoseIntolerant]),
        MealObject(id: 2, mealType: .breakfast, menuName: "Nasi Uduk", calories: 550, protein: 11, carbs: 31, fat: 9, restrictions: [.glutenFree, .dairyFree]),
        MealObject(id: 3, mealType: .breakfast, menuName: "Bubur Ayam", calories: 600, protein: 12, carbs: 32, fat: 10, restrictions: [.dairyFree, .eggAllergy, .lactoseIntolerant]),
        MealObject(id: 4, mealType: .breakfast, menuName: "Oatmeal Buah", calories: 650, protein: 13, carbs: 33, fat: 11, restrictions: [.eggAllergy]),
        MealObject(id: 5, mealType: .breakfast, menuName: "Roti Bakar Selai", calories: 700, protein: 14, carbs: 34, fat: 12, restrictions: [.lactoseIntolerant, .glutenFree]),
        MealObject(id: 6, mealType: .breakfast, menuName: "Smoothie Pisang", calories: 750, protein: 15, carbs: 35, fat: 13, restrictions: [.glutenFree, .dairyFree, .eggAllergy]),
        MealObject(id: 7, mealType: .breakfast, menuName: "Pancake Madu", calories: 800, protein: 16, carbs: 36, fat: 14, restrictions: [.dairyFree]),
        MealObject(id: 8, mealType: .breakfast, menuName: "Telur Rebus", calories: 850, protein: 17, carbs: 37, fat: 15, restrictions: [.eggAllergy, .lactoseIntolerant]),
        MealObject(id: 9, mealType: .breakfast, menuName: "Sereal Susu", calories: 900, protein: 18, carbs: 38, fat: 16, restrictions: [.lactoseIntolerant, .glutenFree, .dairyFree]),
        MealObject(id: 10, mealType: .breakfast, menuName: "Lontong Sayur", calories: 950, protein: 19, carbs: 39, fat: 17, restrictions: [.glutenFree]),
    ]
    
    static let lunch: [MealObject] = [
        MealObject(id: 11, mealType: .lunch, menuName: "Nasi Goreng Ayam", calories: 500, protein: 10, carbs: 30, fat: 8, restrictions: [.lactoseIntolerant]),
        MealObject(id: 12, mealType: .lunch, menuName: "Soto Ayam", calories: 550, protein: 11, carbs: 31, fat: 9, restrictions: [.glutenFree, .dairyFree]),
        MealObject(id: 13, mealType: .lunch, menuName: "Gado-Gado", calories: 600, protein: 12, carbs: 32, fat: 10, restrictions: [.dairyFree, .eggAllergy, .lactoseIntolerant]),
        MealObject(id: 14, mealType: .lunch, menuName: "Ayam Bakar", calories: 650, protein: 13, carbs: 33, fat: 11, restrictions: [.eggAllergy]),
        MealObject(id: 15, mealType: .lunch, menuName: "Pecel Lele", calories: 700, protein: 14, carbs: 34, fat: 12, restrictions: [.lactoseIntolerant, .glutenFree]),
        MealObject(id: 16, mealType: .lunch, menuName: "Rawon", calories: 750, protein: 15, carbs: 35, fat: 13, restrictions: [.glutenFree, .dairyFree, .eggAllergy]),
        MealObject(id: 17, mealType: .lunch, menuName: "Bakso", calories: 800, protein: 16, carbs: 36, fat: 14, restrictions: [.dairyFree]),
        MealObject(id: 18, mealType: .lunch, menuName: "Rendang", calories: 850, protein: 17, carbs: 37, fat: 15, restrictions: [.eggAllergy, .lactoseIntolerant]),
        MealObject(id: 19, mealType: .lunch, menuName: "Nasi Padang", calories: 900, protein: 18, carbs: 38, fat: 16, restrictions: [.lactoseIntolerant, .glutenFree, .dairyFree]),
        MealObject(id: 20, mealType: .lunch, menuName: "Capcay Kuah", calories: 950, protein: 19, carbs: 39, fat: 17, restrictions: [.glutenFree]),
    ]
    
    static let dinner: [MealObject] = [
        MealObject(id: 21, mealType: .dinner, menuName: "Sup Ikan", calories: 500, protein: 10, carbs: 30, fat: 8, restrictions: [.lactoseIntolerant]),
        MealObject(id: 22, mealType: .dinner, menuName: "Salad Sayur", calories: 550, protein: 11, carbs: 31, fat: 9, restrictions: [.glutenFree, .dairyFree]),
        MealObject(id: 23, mealType: .dinner, menuName: "Nasi Merah + Ayam", calories: 600, protein: 12, carbs: 32, fat: 10, restrictions: [.dairyFree, .eggAllergy, .lactoseIntolerant]),
        MealObject(id: 24, mealType: .dinner, menuName: "Tumis Brokoli", calories: 650, protein: 13, carbs: 33, fat: 11, restrictions: [.eggAllergy]),
        MealObject(id: 25, mealType: .dinner, menuName: "Ikan Bakar", calories: 700, protein: 14, carbs: 34, fat: 12, restrictions: [.lactoseIntolerant, .glutenFree]),
        MealObject(id: 26, mealType: .dinner, menuName: "Sup Jagung", calories: 750, protein: 15, carbs: 35, fat: 13, restrictions: [.glutenFree, .dairyFree, .eggAllergy]),
        MealObject(id: 27, mealType: .dinner, menuName: "Sayur Asem", calories: 800, protein: 16, carbs: 36, fat: 14, restrictions: [.dairyFree]),
        MealObject(id: 28, mealType: .dinner, menuName: "Sop Buntut", calories: 850, protein: 17, carbs: 37, fat: 15, restrictions: [.eggAllergy, .lactoseIntolerant]),
        MealObject(id: 29, mealType: .dinner, menuName: "Cah Kangkung", calories: 900, protein: 18, carbs: 38, fat: 16, restrictions: [.lactoseIntolerant, .glutenFree, .dairyFree]),
        MealObject(id: 30, mealType: .dinner, menuName: "Tahu Tempe Bacem", calories: 950, protein: 19, carbs: 39, fat: 17, restrictions: [.glutenFree]),
